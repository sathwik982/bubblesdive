...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `roles` ORDER BY createdDate DESC";
                    ...
                    <table id="aboutTable" class="table table-hover">
                        <thead>
                            <tr>
                                <th>Sl.No</th>
                                <th>Role</th>
                                <?php if ($displayRolesEdit || $displayRolesView || $displayRolesDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php foreach ($roles as $role) : ?>
                                <tr>
                                    ...
                                    <td><?= $role["roleName"] ?></td>
                                    <td>
                                        <?php if ($displayRolesEdit) : ?>
                                            <a href="assign.php?roleId=<?= $role['roleId'] ?>" class="btn btn-success btn-sm">Assign</a>
                                        <?php endif; ?>
                                        <?php if ($displayRolesView) : ?>
                                            <a href="view.php?roleId=<?= $role['roleId'] ?>" class="btn btn-info btn-sm">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayRolesDelete) : ?>
                                            <a href="delete.php?roleId=<?= $role['roleId'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
