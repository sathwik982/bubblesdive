...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET['id'])) {
    ...
    if ($result["status"] === "success" && !empty($result["data"])) {
        $sites = $result["data"][0];
        $confirmation_message = "<h4>Are you sure you want to delete '{$sites['siteName']}' ?</h4>";
    } else {
