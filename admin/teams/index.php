...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `teams` ORDER BY createdDate DESC";
...
<div class="page-container">
    ...
    <div class="main-content">
        <div class="page-headers">
            <h2 class="header-title">Teams</h2>
                    ...
                    <table id="dataTable" class="table table-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Staff Photo</th>
                                <th>Status</th>
                                <?php if ($displayTeamsEdit || $displayTeamsView || $displayTeamsDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (!empty($team["photo"])) : ?>
                                            <a href="<?= $team["photo"] ?>" target="_blank" style="text-decoration:none;">Click me</a>
                                        <?php else : ?>
                                            <span class="-">-</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <?php if ($displayTeamsEdit) : ?>
                                            <a href="edit.php?id=<?= $team['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayTeamsView) : ?>
                                            <a href="view.php?id=<?= $team['id'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayTeamsDelete) : ?>
                                            <a href="delete.php?id=<?= $team['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
