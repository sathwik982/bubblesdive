...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `terms_conditions` ORDER BY createdDate DESC";
...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="container">
            <?php if ($displayTermsConditionsAdd) : ?>
                    ...
                    <table id="aboutTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Refund Polciy</th>
                                <th>Liability Disclaimer</th>
                                <th>Status</th>
                                <?php if ($displayTermsConditionsEdit || $displayTermsConditionsView || $displayTermsConditionsDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php foreach ($terms_conditions as $tc) : ?>
                                <tr>
                                    ...
                                    <td><?= $tc["title"] ?></td>
                                    <td><?= $tc["content"] ?></td>
                                    <td><?= $tc["cancellationPolicy"] ?></td>
                                    <td><?= $tc["refundPolicy"] ?></td>
                                    <td><?= $tc["liabilityDisclaimer"] ?></td>
                                    <td><?php
                                        $status = $tc["status"];
                                        if ($status == "PUBLISH") {
                                        ...
                                        ?></td>
                                    <td>
                                        <?php if ($displayTermsConditionsEdit) : ?>
                                            <a href="edit.php?id=<?= $tc['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayTermsConditionsView) : ?>
                                            <a href="view.php?id=<?= $tc['id'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayTermsConditionsDelete) : ?>
                                            <a href="delete.php?id=<?= $tc['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
