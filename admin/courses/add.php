...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($status)) {
        $sql = "INSERT INTO `courses` (courseName, courseType, price, status) VALUES (?, ?, ?, ?)";
        $params = [$courseName, $courseType, $price, $status];
...
$sql = "SELECT *, DATE_FORMAT(createdDate, '%d-%b-%Y') as `cdate` FROM `courses`";
$result = $db->run($sql);
                        ...
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="courseType" id="courseType" placeholder="Course Type" required>
