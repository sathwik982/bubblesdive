...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `trips` ORDER BY createdDate DESC";
...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-headers">
            <h2 class="header-title">Trips</h2>
                    ...
                    <table id="dataTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Location</th>
                                <th>Status</th>
                                <?php if ($displayTripsEdit || $displayTripsView || $displayTripsDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <?php foreach ($trips as $trip) : ?>
                                <tr>
                                    ...
                                    <td><?= $trip["tripName"] ?></td>
                                    <td><?= $trip["price"] ?></td>
                                    <td><?php if (!empty($trip["tripPicture"])) : ?>
                                            <a href="<?= $trip["tripPicture"] ?>" target="_blank" style="text-decoration:none;">Click me</a>
                                        <?php else : ?>
                                            <span class="-">-</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><?= isset($trip["tripDuration"]) ? $trip["tripDuration"] . ' days' : '' ?></td>
                                    <td><?= $trip["tripDate"] ?></td>
                                    ...
                                    <td>
                                        <?php if ($displayTripsEdit) : ?>
                                            <a href="edit.php?tripId=<?= $trip['tripId'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayTripsView) : ?>
                                            <a href="view.php?tripId=<?= $trip['tripId'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayTripsDelete) : ?>
                                            <a href="delete.php?tripId=<?= $trip['tripId'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
