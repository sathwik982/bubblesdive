...
$sql = "SELECT *, DATE_FORMAT(createdDate, '%d-%b-%Y') as `cdate` FROM `producttype` ORDER BY createdDate DESC";
...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-headers">
            <h2 class="header-title">Product Type</h2>
                    ...
                    <table id="dataTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Price</th>
                                <th>Status</th>
                                <?php if ($displayProductTypeEdit || $displayProductTypeView || $displayProductTypeDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($producttype as $details) : ?>
                                <tr>
                                    <td><?= $i++; ?></td>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <?php if ($displayProductTypeEdit) : ?>
                                            <a href="edit.php?productTypeId=<?= $details['productTypeId'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayProductTypeView) : ?>
                                            <a href="view.php?productTypeId=<?= $details['productTypeId'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayProductTypeDelete) : ?>
                                            <a href="delete.php?productTypeId=<?= $details['productTypeId'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
