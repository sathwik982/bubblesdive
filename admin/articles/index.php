...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `blogs` ORDER BY createdDate DESC";
                    ...
                    <table id="aboutTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Article Image</th>
                                <th>Status</th>
                                <?php if ($displayBlogsEdit || $displayBlogsView || $displayBlogsDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        if (!empty($blog["blogImage"])) {
                                            echo '<a href="' . $blog["blogImage"] . '" target="_blank" style="text-decoration:none;">Click me</a>';
                                        } else {
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <?php if ($displayBlogsEdit) : ?>
                                            <a href="edit.php?id=<?= $blog['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayBlogsView) : ?>
                                            <a href="view.php?id=<?= $blog['id'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayBlogsDelete) : ?>
                                            <a href="delete.php?id=<?= $blog['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
