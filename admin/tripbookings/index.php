...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `trip_bookings` ORDER BY createdDate DESC";
...
$sqltrips = "SELECT tripId, tripName FROM trips";
$stmt = $db->getConnection()->prepare($sqltrips);
$stmt->execute();
...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-headers">
            <h2 class="header-title">Trip Bookings</h2>
                    ...
                    <table id="aboutTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Booking Date</th>
                                <th>Total Price</th>
                                <?php if ($displayTripBookingsView) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($trip_bookings as $trip_booking) : ?>
                                <?php
                                ...
                                foreach ($customers as $customer) {
                                    if ($customer['customerId'] === $trip_booking['customerId']) {
                                ...
                                foreach ($trips as $trip) {
                                    if ($trip['tripId'] === $trip_booking['tripId']) {
                                ...
                                foreach ($languages as $language) {
                                    if ($language['languageId'] === $trip_booking['languageId']) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($displayTripBookingsView) : ?>
                                            <a href="view.php?bookingId=<?= $trip_booking['bookingId'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
