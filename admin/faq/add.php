...
$sql = "SELECT *, DATE_FORMAT(createdDate, '%d-%b-%Y') as `cdate` FROM `faq`";
$result = $db->run($sql);
                        ...
                        <div class="card-body">
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                                ...
                                <div class="form-group shadow-textarea">
                                    ...
                                    <textarea class="form-control z-depth-1" id="answer" name="answer" rows="5" placeholder="Write Something here.." required></textarea>
                                </div>
                                <div class="mb-3">
