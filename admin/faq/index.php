...
$sql = "SELECT *, DATE_FORMAT(createdDate,'%d-%b-%Y') as `cdate` FROM `faq` ORDER BY createdDate DESC";
                    ...
                    <table id="aboutTable" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Answer</th>
                                <th>Status</th>
                                <?php if ($displayFAQEdit || $displayFAQView || $displayFAQDelete) : ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                            ...
                            <?php foreach ($faq as $question) : ?>
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td>
                                        <?php if ($displayFAQEdit) : ?>
                                            <a href="edit.php?id=<?= $question['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                                        <?php endif; ?>
                                        <?php if ($displayFAQView) : ?>
                                            <a href="view.php?id=<?= $question['id'] ?>" class="btn btn-sm btn-info">View</a>
                                        <?php endif; ?>
                                        <?php if ($displayFAQDelete) : ?>
                                            <a href="delete.php?id=<?= $question['id'] ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
