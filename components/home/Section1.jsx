...
import bgVideo from "../../lib/assets/home/1874406_Snorkeling_Reef_Undersea_1920x1080.mp4";
import {
  IoIosArrowBack,
  IoIosArrowForward,
  IoMdClose,
  ...
  return (
    <>
      ...
      >
        ...
        {!selectedCourse ? (
          <div
            className="text-white  w-full px-4 z-[200] flex flex-col md:flex-row
          ...
          >
            <div className="flex flex-col gap-3 max-w-[400px] ">
              ...
              <p className="text-gray-300">
                Dive into crystal-clear waters and encounter a myriad of marine
