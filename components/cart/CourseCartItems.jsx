...
const CourseCartItems = ({ cartItems }) => {
  const { addCourseToCart, removeCourseFromCart, clearCourseFromCart } =
    useCourseContext();
  const { isDarkMode } = useThemeContext();
  return (
    <div className=" ">
      <ul role="list" className="md:my-3 ">
        {cartItems?.map((cart) => (
          <li
              ...
              <div className="flex w-full items-center mt-3 justify-between text-sm px-3">
                <div className="text-gray-500 flex gap-2 items-center">
                  <button
                    ...
                    onClick={() => removeCourseFromCart(cart)}
                  >
                    -
                  </button>
                ...
                <div className="flex">
                  <button
                    ...
                    `}
                    onClick={() => clearCourseFromCart(cart?.id)}
                  >
                    Remove
                  </button>
                </div>
...
export default CourseCartItems;
