...
import image1 from "../../lib/assets/aboutus/image-1.png";
  ...
  const testimonials = [
    {
      ...
      name: "Mary Taba ",
      image:
        "https://media.istockphoto.com/id/685132223/photo/businesswoman-with-braided-hair-over-white.jpg?s=1024x1024&w=is&k=20&c=RLKPZtDz1TklhcD6FIPlCYZReMB4H0WS2Yt0rNikaSE=",
    },
    {
      id: "2",
  ...
  const activities = [
    {
      ...
      image: image1,
      description:
        "Underwater exploration with SCUBA gear to observe marine life.",
    },
    {
      title: "Technical Diving",
      image: image1,
      description:
        "Using specialized equipment for deep and challenging dives.",
    },
    {
      title: "Rebreather/CCR Diving",
      image: image1,
      description: "Extending dive time using closed-circuit rebreathers.",
    },
    {
      title: "Snorkelling/Swimming",
      image: image1,
      description:
        "Surface observation of marine life and recreational swimming.",
    },
    {
      title: "Conservation",
      image: image1,
      description:
        "Protecting marine ecosystems through monitoring and cleanup.",
    },
    {
      title: "First Aid/CPR",
      image: image1,
      description: "Emergency response training for diving medical incidents.",
    },
    {
      title: "Public Safety Diving",
      image: image1,
      description: "Diving for law enforcement, rescue, and evidence recovery.",
    },
    {
      title: "Adaptive Diving",
      image: image1,
      description: "Making diving accessible to people with disabilities.",
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "The ocean is home to a rich tapestry of life, and we celebrate the beauty of its many inhabitants.",
    },
    {
      title: "Conservation commitment",
      description:
        "We are dedicated to protecting the ocean and all who depend on it, now and in the future.",
    },
    {
      title: "Safety first",
      description:
        "We prioritize the well-being of divers and promote responsible diving practices.",
    },
  ];
    ...
    <div className={`${isDarkMode ? "bg-gray-900" : "bg-white"}`}>
      ...
      <div className="max-w-[1300px] mx-auto py-10 px-5 ">
        <div className="flex flex-col gap-10 md:gap-14 lg:gap-20">
          <div className="flex justify-between items-start gap-5 flex-col lg:flex-row max-w-[1200px]  ">
            <div className="md:px-3 lg:px-5  lg:max-w-[600px]">
              <h2
                className={`${
                  isDarkMode ? "text-blue-700" : "text-primary"
                } text-xl md:text-2xl lg:text-3xl lg font-semibold tracking-tighter  py-2
          `}
              >
                Overview
              </h2>
              <p
                ...
                }  px-1 md:px-2 text-sm md:text-base`}
              >
                It all started with a clear vision of three childhood friends
                where diving is a passion. Abdulrahman Al-Sarheed, Abdulkarim
                Al-Saleh, turned their dream to reality by establishing Bubbles
                Diving Center in 2009 with a unique approach. During the 13
                years of Al-Sarheed&apos;s diving career he noticed natural born
                divers doing what they do professionally for their love for
                diving, hence they became a part of Bubbles Diving Center staff.
              </p>
            </div>

            <div className="flex  gap-3 ml-auto  md:justify-end flex-wrap md:flex-nowrap w-fit " >
              <img
                src={
                  "https://d2p1cf6997m1ir.cloudfront.net/media/thumbnails/75/77/75771abb61dd537457711b81acdc66bd.webp"
                }
                alt="Image 1"
                layout="fill"
                className="rounded-lg object-cover w-full sm:w-[200px] h-[200px]  md:h-[250px] place-self-end"
              />{" "}
              <img
                src={
                  "https://d2p1cf6997m1ir.cloudfront.net/media/thumbnails/fd/b5/fdb518db8f2ecf1385786aab605698f9.webp"
                }
                alt="Image 1"
                layout="fill"
                className="rounded-lg  object-cover w-full sm:w-[200px] h-[250px]  md:h-[300px]"
              />
            </div>
          </div>
          ...
          `}
            ...
            <div className="grid sm:grid-cols-3 lg:grid-cols-4 justify-center flex-wrap gap-4 my-5">
              {activities.map((activity, idx) => (
                <ActivityCard activity={activity} key={idx} index={idx} />
              ))}
            </div>
          </div>
          ...
          `}
            ...
            >
              We believe that with a greater understanding of the ocean comes a
              deeper appreciation for its fragile ecosystems. That&apos;s why we
              are committed to promoting ocean conservation through education
              and advocacy. We support marine protected areas, sustainable
              fishing practices, and efforts to reduce plastic pollution. By
              inspiring more people to love the ocean, we hope to create a
              community of stewards dedicated to preserving it for future
              generations.
            </p>
          </div>
          ...
          `}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-5 flex-wrap my-5">
          ...
          `}
            ...
            <div className="my-5  px-5 flex items-center gap-5 md:gap-8 lg:gap-10 overflow-x-auto">
              {partners.map((partner, idx) => (
                <PartnersCard key={idx} partner={partner} />
              ))}
            </div>
          </div>
          ...
          `}
            ...
            <div className="my-5  px-5 flex items-center gap-5 md:gap-8 lg:gap-10">
              <TeamCard />
            </div>
          </div>
          ...
          `}
            ...
            <div className=" my-5 flex gap-5 flex-wrap justify-evenly ">
              {testimonials.map((item, idx) => (
                <div
                  className={`flex flex-col justify-between max-w-[550px] rounded-lg shadow-lg ${
                    isDarkMode ? "bg-gray-800" : "border bg-white"
                  }`}
                  key={idx}
                >
                  <div className="p-3">
                    <p
                      ...
                      } text-lg font-medium px-4 py-1`}
                    >
                      {item.text}
                    </p>
                  </div>
                  <div
                    className={`" bottom-0 rounded-b-lg flex items-center gap-x-4 p-4 mt-3 ${
                      isDarkMode ? "bg-gray-950 shadow-lg" : "bg-blue-50"
                    } `}
                  >
                    <img
                      alt=""
